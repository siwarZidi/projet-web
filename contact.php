        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="d-flex flex-column mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Centre Urbain Nord</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>S&JFashion@gmail.com</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>29708967</p>
                </div>
                <div class="d-flex flex-column">
                    <h5 class="font-weight-semi-bold mb-3">Store 2</h5>
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>L'aouina</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>S&JFashion2@gmail.com</p>
                    <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>23415194</p>
                </div>
            </div>
        </div>
    </div>
